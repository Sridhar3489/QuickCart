    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (sendEmail(email, "Your Verification Code for QuickCart", "Your OTP is: " + otp)) {
            ...
            if (enteredOtp != null && enteredOtp.equals(String.valueOf(otp))) {
                ...
                Customer c = ecosystem.getCustomerDirectory().createCustomer(firstName + " " + lastName, email, phone, address);
                CustomerAccount ca = ecosystem.getUserAccountDirectory().createCustomerAccount(username, password, new business.Role.CustomerRole());
                ca.setCustomer(c);
